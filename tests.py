...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow_sheets(self):
        # create four users
        u1 = User(username='john', email='john@example.com', id=1)
        u2 = User(username='susan', email='susan@example.com', id=2)
        u3 = User(username='mary', email='mary@example.com', id=3)
        u4 = User(username='david', email='david@example.com', id=4)
